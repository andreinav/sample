---
title : 'Part 1: Technical Assessment (Dynamic Version)'
...
``` {r dynamic plot, echo = FALSE, warning = FALSE, cache = FALSE, message = FALSE, fig.align='center'}

#create dynamic graph using pplotly
plot2 <- ggplotly(plot) %>%
              layout (autosize = F,
                      width = 800,
                      height = 450,
                      xaxis = list (tickangle = 7, title = "Year", titlefont = list(size = 10)),
                      yaxis = list (title = "Access to improved water (% of pop.)",
